...
fn main() {
    let shirt_c = ShirtColor::new(Color::Blue);
    let pants_c = PantsColor::new(Color::Blue);
    let shoes_c = ShoesColor::new(Color::Blue);

    print_shirt_color(shirt_c);
    print_pants_color(pants_c);
    print_shoes_color(shoes_c)
}
